# Generated by Powerlevel10k configuration wizard on 2022-01-28 at 16:16 CET.
...
# solid, left frame, darkest-ornaments, sparse, few icons, concise, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # jtimewarrior             # timewarrior tracking status (https://timewarrior.net/)
  ...
  # Show <account>-<cluster> if it's given, otherwise show <context-name>
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION='${${P9K_KUBECONTEXT_CLOUD_ACCOUNT:+${P9K_KUBECONTEXT_CLOUD_ACCOUNT}-${P9K_KUBECONTEXT_CLOUD_CLUSTER}}:-${P9K_KUBECONTEXT_NAME}}'
